...
/**
 * This is the dealer player class.<p>
 * 
 * The dealer only shows its second card at the beginning of her turn, should 
 * no-one lose by default before then.<p>
 * 
 * Dealer will hit up until his hand is a total of 16.
 * 
 * @author Aizic Moisen
 */
