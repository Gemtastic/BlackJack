...
/**
 * This is my simple BlackJack game.<p>
 * 
 * In this game I have chosen to make it as simple as I can whilst still 
 * functional. There are two players; dealer and user. User goes first,
 * then the dealer has her turn.<p>
 * 
 * The game lets the other player auto-win if the hand-total is more than
 * 21. That same function also assures that no player will have a hand higher
 * than 21.<p>
 * 
 * The game compares the users results to each other and the highest hand wins.
 * If there's a stalemate, dealer wins.
 * 
 * @author Aizic Moisen
 */
